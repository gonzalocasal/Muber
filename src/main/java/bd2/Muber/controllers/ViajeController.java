...
import bd2.Muber.dtos.FinalizarViajeDTO;
...
public class ViajeController {
	...
	public Map<String, Object> finalizar( 	@RequestBody FinalizarViajeDTO viajeDTO){
		String result = (conductorService.finalizarViaje(viajeDTO.getViajeId())) ? "OK" : "Error, el viaje fue cerrado previamente";
		Map<String, Object> aMap = new HashMap<String, Object>();
